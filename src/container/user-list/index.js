...
class UserList extends List {
  constructor() {
    ...
    if (!this.element) throw new Error('Elemet is null')
    this.loadData()
  }

  loadData = async () => {
    this.updateStatus(this.STATE.LOADIND)
  ...
  updateView = () => {
    ...
    switch (this.status) {
      case this.STATE.LOADIND:
        // this.element.innerHTML = ` <span class="alert alert--progress"> Завантаження...</span>`
        this.element.innerHTML += `
	   <div  class="user ">
