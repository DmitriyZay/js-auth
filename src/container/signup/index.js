...
class SignupForm extends Form {
  ...
  FIELD_ERROR = {
    ...
    IS_BIG: 'Дуже довге значення, скоротіть.',
    EMAIL: 'Ввкдіть коректне значення e-mail адреси.',
    PASSWORD:
      'Пароль повинен складатись не менш ніж 8 символів, включати заглавні літери та цифри.',
    PASSWORD_AGAIN:
